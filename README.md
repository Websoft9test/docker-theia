...
```
sudo wget -N https://raw.githubusercontent.com/Websoft9/StackHub/main/docker-installer.sh; sudo bash docker-installer.sh -r theia
```
### package install
...
```
sudo wget -N https://raw.githubusercontent.com/Websoft9/StackHub/main/docker-installer.sh; sudo bash docker-installer.sh -r theia -p
```
...
```
git clone --depth=1 https://github.com/Websoft9/docker-theia
cd docker-theia
...
| --- | --- | --- | --- |
| Theia | 9001 | Browser access to Theia Document by HTTP | Y |
## Documentation

[Theia Administrator Guide](https://support.websoft9.com/docs/theia)

## Enterprise Support

If you want to get our Enterprise Support to ensure high availability of applications, you can subscribe our [Theia Enterprise Support](https://apps.websoft9.com/theia) 
